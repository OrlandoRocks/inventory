class OfficesController < ApplicationController
  ...
  # GET /offices.json
  def index
    @search_offices = policy_scope(Office).ransack(params[:q])
    @offices = @search_offices.result.paginate(page: params[:page], per_page: 20)
  ...
  private
    ...
    def office_params
      params.require(:office).permit(:name, :description, :department_id, :user_id)
    end
end
