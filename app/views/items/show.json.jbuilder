json.extract! @item, :id, :name, :sub_category, :description,:code, :model, :branch_id, :accessory, :remission,
              :serial_number, :purchased_date, :in_service_date, :time_unit_service, :time_quantity_service,
              ...
              :client_id, :client, :trailer_id, :user, :status_shipping_id, :advance_payment
