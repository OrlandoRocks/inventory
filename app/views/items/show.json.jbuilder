json.extract! @item, :id, :name, :description,:code, :model, :branch_id, :accessory, :remission,
              :serial_number, :purchased_date, :acquisition_date, :in_service_date, :time_unit_service, :time_quantity_service,
              :price, :time_unit_depreciation, :sale_price, :time_quantity_depreciation, :provider_id,
              :department_id, :user_id, :brand, :status_item_id, :fiscal_voucher, :fiscal_voucher_id, :payment_type,
