class ItemSerializer < ActiveModel::Serializer
  ...
  attributes :id,:name, :code, :description, :image, :model, :serial_number, :purchased_date,
             :in_service_date, :time_unit_service, :time_quantity_service, :price, :category,
             :time_unit_depreciation, :time_quantity_depreciation, :sub_category_id, :sub_category, :provider_id,
