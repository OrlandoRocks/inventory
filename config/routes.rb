    ...
    authenticate :user do
      ...
      namespace :api, defaults: {format: 'json'} do
        namespace :v1 do        
          ...
          put 'create_item/:token' => 'inventory_manager#create_item'
          put 'update_item/:token' => 'inventory_manager#update_item'
          put 'create_trailer/:token' => 'trailer_manager#create_trailer'
          put 'update_trailer/:token' => 'trailer_manager#update_trailer'
          put 'create_client/:token' => 'client_manager#create_client'
          put 'update_client/:token' => 'client_manager#update_client'
          delete 'destroy_client/:token' => 'client_manager#destroy_client'
          delete 'destroy_trailer/:token' => 'trailer_manager#destroy_trailer'
          delete 'destroy_item/:token' => 'inventory_manager#destroy_item'
        end
      end
    end
  end
