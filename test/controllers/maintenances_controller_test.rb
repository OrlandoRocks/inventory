...
class MaintenancesControllerTest < ActionController::TestCase
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post :create, maintenance: { description: @maintenance.description, name: @maintenance.name, status: @maintenance.status }
    end
  ...
  test "should update maintenance" do
    patch :update, id: @maintenance, maintenance: { description: @maintenance.description, name: @maintenance.name, status: @maintenance.status }
    assert_redirected_to maintenance_path(assigns(:maintenance))
  end
