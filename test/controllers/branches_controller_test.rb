...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { city_id: @branch.city_id, company_id: @branch.company_id, description: @branch.description, manager_id: @branch.manager_id, name: @branch.name }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { city_id: @branch.city_id, company_id: @branch.company_id, description: @branch.description, manager_id: @branch.manager_id, name: @branch.name }
    assert_redirected_to branch_path(assigns(:branch))
  end
