...
ActiveRecord::Schema.define(version: 2021_07_09_224526) do
  ...
  create_table "quotations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["brake_type_id"], name: "index_quotations_on_brake_type_id"
    t.index ["branch_id"], name: "index_quotations_on_branch_id"
    t.index ["brand_id"], name: "index_quotations_on_brand_id"
    t.index ["capacity_id"], name: "index_quotations_on_capacity_id"
    t.index ["client_id"], name: "index_quotations_on_client_id"
    t.index ["color_id"], name: "index_quotations_on_color_id"
    t.index ["department_id"], name: "index_quotations_on_department_id"
    t.index ["divition_type_id"], name: "index_quotations_on_divition_type_id"
    t.index ["fender_type_id"], name: "index_quotations_on_fender_type_id"
    t.index ["floor_type_id"], name: "index_quotations_on_floor_type_id"
    t.index ["hydraulic_jack_id"], name: "index_quotations_on_hydraulic_jack_id"
    t.index ["pull_type_id"], name: "index_quotations_on_pull_type_id"
    t.index ["ramp_type_id"], name: "index_quotations_on_ramp_type_id"
    t.index ["redila_type_id"], name: "index_quotations_on_redila_type_id"
    t.index ["roof_type_id"], name: "index_quotations_on_roof_type_id"
    t.index ["suspension_type_id"], name: "index_quotations_on_suspension_type_id"
    t.index ["trailer_length_id"], name: "index_quotations_on_trailer_length_id"
    t.index ["trailer_type_id"], name: "index_quotations_on_trailer_type_id"
    t.index ["trailer_width_id"], name: "index_quotations_on_trailer_width_id"
    t.index ["turn_type_id"], name: "index_quotations_on_turn_type_id"
  ...
  add_foreign_key "quotations", "brake_types"
  add_foreign_key "quotations", "branches"
  add_foreign_key "quotations", "brands"
  add_foreign_key "quotations", "capacities"
  add_foreign_key "quotations", "clients"
  add_foreign_key "quotations", "colors"
  add_foreign_key "quotations", "departments"
  add_foreign_key "quotations", "divition_types"
  add_foreign_key "quotations", "fender_types"
  add_foreign_key "quotations", "floor_types"
  add_foreign_key "quotations", "hydraulic_jacks"
  add_foreign_key "quotations", "pull_types"
  add_foreign_key "quotations", "ramp_types"
  add_foreign_key "quotations", "redila_types"
  add_foreign_key "quotations", "roof_types"
  add_foreign_key "quotations", "suspension_types"
  add_foreign_key "quotations", "trailer_lengths"
  add_foreign_key "quotations", "trailer_types"
