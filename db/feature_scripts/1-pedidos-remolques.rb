...
permissions_from_other_controllers = [
    ...
    { name: 'Ver la lista de gatos hirdaulicos', description: 'Permite ver la lista de gatos hidraulicos',
    ...
    { name: 'Ver detalle de articulo', description: 'Permite ver detalle de articulo',
