after :devise_user do
    ...
    Category.create(name: 'Carhauler',  status: 'true', company_id: Company.first.id) 
    Category.create(name: 'Volteo',  status: 'true', company_id: Company.first.id) 
    Category.create(name: 'Cama Alta Jalon Defensa',  status: 'true', company_id: Company.first.id) 
    Category.create(name: 'Cama Alta Cuello de Ganso',  status: 'true', company_id: Company.first.id) 
    Category.create(name: 'Caballos Sencillo',  status: 'true', company_id: Company.first.id) 
    Category.create(name: 'Caballos Equipado',  status: 'true', company_id: Company.first.id) 
end