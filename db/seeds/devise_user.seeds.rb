...
# Restarts ids to 1.
    ...
    User.create(email: 'god@example.com', username: 'divinity', first_name: 'God', last_name: 'System',
                ...
                department_id: Department.where(name: 'Oficina Central').first.id, current_company: Company.first.id)

    Company.first.update(user_id: User.first.id)
    ...
    User.create(email: 'peter.loewen@agroplanet.com', username: 'Admin Peter', first_name: 'Pedro', last_name: 'Loewen',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 1000,
                department_id: Department.where(name: 'Oficina Central').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'hugo.reyes@agroplanet.com', username: 'Gerente Arteaga', first_name: 'Hugo', last_name: 'Reyes',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 2000,
                department_id: Department.where(name: 'Arteaga').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'oscar.guevara@agroplanet.com', username: 'Gerente Arteaga', first_name: 'Óscar', last_name: 'Guevara',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 3000,
                department_id: Department.where(name: 'Irapuato').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'daniel.ramirez@agroplanet.com', username: 'Vendedor Daniel', first_name: 'Daniel', last_name: 'Ramirez',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 3101,
                department_id: Department.where(name: 'Irapuato').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'lucero.cortez@agroplanet.com', username: 'Vendedor Daniel', first_name: 'Lucero', last_name: 'Cortez',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 3102,
                department_id: Department.where(name: 'Irapuato').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'raymundo.leon@agroplanet.com', username: 'Gerente Irapuato', first_name: 'Raymundo', last_name: 'Leon',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 4000,
                department_id: Department.where(name: 'Cueramaro').first.id, current_company: Company.first.id)
    ...
    User.create(email: 'eduardo.ramos@agroplanet.com', username: 'Vendedor Marcos Eduardos', first_name: 'Marcos Eduardo', last_name: 'Ramos',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 4102,
                department_id: Department.where(name: 'Cueramaro').first.id,current_company: Company.first.id)
    ...
    User.create(email: 'eduardo.turner@agroplanet.com', username: 'Gerente Manclova', first_name: 'Eduardo', last_name: 'Turner',
                ...
                confirmed_at: Time.now, sign_in_count: 0, employee_number: 5000,
                department_id: Department.where(name: 'Monclova').first.id, current_company: Company.first.id)
